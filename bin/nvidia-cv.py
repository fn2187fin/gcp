...
def nvidia_smi():
    ...
    for l in res_cmd('nvidia-smi'):
        ...
        if re.findall('iB',lstr) and re.findall('C',lstr) and re.findall('W',lstr):
            ...
            continue
    return gpu_line,fan,usedmem,maxmem,usedgpu,temp
...
if __name__ == '__main__':
    ...
    for igpu in range(0,gpuN):
        ...
        start_tmp.append((5,igpu*100+1))
    ix = 2
    while True:
        gpuN,_,usedmem,maxmem,usedgpu,temp = nvidia_smi()
        for igpu in range(0,gpuN):
            oset = igpu*height
            #axis
